...
Public Class FRMMAIN
    ...
    Private Sub oCommBalanza_DataReceived(ByVal sender As Object, ByVal e As System.IO.Ports.SerialDataReceivedEventArgs) Handles oCommBalanza.DataReceived
    ...
    Sub PesoBalanza(ByVal cData As String)
        ...
        If cTrama.Length >= 14 Then
            ...
            Dim nPos As Integer = InStr(cTrama, Chr(61), CompareMethod.Text) + 1
            Dim cPart = Mid(cTrama, nPos, 7)
            Dim cEnvia = StrReverse(cPart)
            cPesoBalanza = cEnvia
            'cPesoBalanza = Mid(cTrama, nPos, 7)
            cTrama = String.Empty
        End If
    End Sub
